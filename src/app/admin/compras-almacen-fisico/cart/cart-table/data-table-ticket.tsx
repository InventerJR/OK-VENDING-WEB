...
import DataTableTicketTotal from "./data-table-ticket-total";


const CartDataTableTicket = () => {
            ...
            <table className='w-full'>
                <thead >
                    <tr className='bg-[#2C3375] text-white'>
                        ...
                        <th className='px-2 py-1 md:px-4 md:py-2 text-left'>Precio</th>
                        <th className='px-2 py-1 md:px-4 md:py-2 text-left'>Subtotal</th>
...
export default CartDataTableTicket;