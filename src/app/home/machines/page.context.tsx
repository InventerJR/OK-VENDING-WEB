...
const CreateUserModal = dynamic(() => import('./modals/create-modal'));
const DeleteUserModal = dynamic(() => import('./modals/delete-modal'));
const UpdateUserModal = dynamic(() => import('./modals/update-modal'));
